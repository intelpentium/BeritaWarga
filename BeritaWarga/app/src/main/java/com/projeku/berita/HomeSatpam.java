...
import com.projeku.berita.Fragment.Notif;
import com.projeku.berita.Fragment.Ronda;
import com.projeku.berita.Fragment.WargaUtama;
...
public class HomeSatpam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.satpam_home);
...
//        Toast.makeText(HomeSatpam.this, FirebaseInstanceId.getInstance().getToken(), Toast.LENGTH_LONG).show();
        ...
        String pos = sharedPreferences.getString("pos","Not Available");
        ...
        if(pos.equals("notif")){
            ...
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.frame, WargaUtama.newInstance())
                    .commit();
...
//            Toast.makeText(getApplicationContext(), ""+savedInstanceState,Toast.LENGTH_LONG).show();
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(HomeSatpam.this, Login.class);
                startActivity(i);
                finish();
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("type_log", "Satpam");
                editor.commit();

                Intent i = new Intent(HomeSatpam.this, EditProfile.class);
                startActivity(i);
            }
        });
        ...
        Log.e("photo",photo);
        Glide.with(HomeSatpam.this).load(photo)
