...
public class HomeWarga extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.warga_home);
...
//            Toast.makeText(getApplicationContext(), ""+savedInstanceState,Toast.LENGTH_LONG).show();
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(HomeWarga.this, Login.class);
                startActivity(i);
                finish();
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("type_log", "Warga");
                editor.commit();

                Intent i = new Intent(HomeWarga.this, EditProfile.class);
                startActivity(i);
            }
        });
        ...
        Log.e("photo",photo);
        Glide.with(HomeWarga.this).load(photo)
