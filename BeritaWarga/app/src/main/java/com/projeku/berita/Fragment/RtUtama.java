...
import com.projeku.berita.RtAdd;
...
public class RtUtama extends Fragment {
    ...
    public static RtUtama newInstance() {
        return new RtUtama();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.rt_utama, container, false);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getActivity(), RtAdd.class);
                startActivity(i);
            }
        });
