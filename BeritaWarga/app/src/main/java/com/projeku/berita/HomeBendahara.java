...
public class HomeBendahara extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bendahara_home);
...
//            Toast.makeText(getApplicationContext(), ""+savedInstanceState,Toast.LENGTH_LONG).show();
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(HomeBendahara.this, Login.class);
                startActivity(i);
                finish();
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("type_log", "Bendahara");
                editor.commit();

                Intent i = new Intent(HomeBendahara.this, EditProfile.class);
                startActivity(i);
            }
        });
        ...
        Log.e("photo",photo);
        Glide.with(HomeBendahara.this).load(photo)
