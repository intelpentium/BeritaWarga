...
import com.projeku.berita.Fragment.BeritaKejahatan;
import com.projeku.berita.Fragment.GantiPassword;
import com.projeku.berita.Fragment.KasPeriode;
import com.projeku.berita.Fragment.LaporanPanik;
import com.projeku.berita.Fragment.Map;
import com.projeku.berita.Fragment.Panik;
import com.projeku.berita.Fragment.Ronda;
import com.projeku.berita.Fragment.RtJabatan;
import com.projeku.berita.Fragment.RtUtama;
...
public class HomeRt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rt_home);
...
//            Toast.makeText(getApplicationContext(), ""+savedInstanceState,Toast.LENGTH_LONG).show();
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(HomeRt.this, Login.class);
                startActivity(i);
                finish();
            }
        });
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()){
                    ...
                    case R.id.posting:
                        Intent i = new Intent(HomeRt.this, RtAdd.class);
                        startActivity(i);
                        return true;

                    case R.id.laporan:
                        getSupportActionBar().setTitle("Laporan Panik");

                        getSupportFragmentManager()
                                .beginTransaction()
                                .replace(R.id.frame, LaporanPanik.newInstance())
                                .commit();
                        return true;
                    ...
                    case R.id.ganti:
                        ...
                        getSupportFragmentManager()
                                .beginTransaction()
                                .replace(R.id.frame, GantiPassword.newInstance())
                                .commit();
                        return true;
                    default:
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("type_log", "RT");
                editor.commit();

                Intent i = new Intent(HomeRt.this, EditProfile.class);
                startActivity(i);
            }
        });
        ...
        Log.e("photo",photo);
        Glide.with(HomeRt.this).load(photo)
